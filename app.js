...
function render() {
  ...
  document.querySelector('#yearly-kicker').textContent = phrase('yearKicker'); document.querySelector('#yearly-title').textContent = phrase('yearTitle'); document.querySelector('#yearly-select-label').textContent = phrase('selectYear');
