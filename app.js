...
function renderCharts(ranked) {
  ...
  visibleMatches().forEach(match => scoreGroups.set(match.score, (scoreGroups.get(match.score) || 0) + 1));
  charts = [
