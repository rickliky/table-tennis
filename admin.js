(() => {
  ...
  const playerStatusLabel = value => lookupName('statuses', value);
  ...
  const entityFields = {
    ...
    tournamentProgress: [['tournamentProgressId', '進捗ID / Progress ID', 'text', true], ['tournamentId', '大会ID / Tournament ID', 'tournament', true], ['division', 'Division / ディビジョン', 'text'], ['playerId', '選手 / Player', 'player', true], ['rank', '順位 / Rank', 'number'], ['recommended', '推薦 / Recommended', 'select', false, [['',''],['true','Yes','はい'],['false','No','いいえ']]], ['qualified', '代表 / Representative', 'select', false, [['',''],['true','Yes','はい'],['false','No','いいえ']]], ['totalWins', '勝利数 / Total wins', 'number'], ['totalLosses', '敗北数 / Total losses', 'number'], ['totalDraws', '引き分け / Total draws', 'number'], ['eliminated', '敗退 / Eliminated', 'select', false, [['',''],['true','Yes','はい'],['false','No','いいえ']]]]
  };
