(() => {
  ...
  const entityFields = {
    ...
    tournamentProgress: [['tournamentProgressId', '進捗ID / Progress ID', 'text', true], ['tournamentId', '大会ID / Tournament ID', 'text', true], ['playerId', '選手ID / Player ID', 'text'], ['playerName', '選手名 / Player name', 'text'], ['round', 'ラウンド / Round', 'select', false, ['', '1回戦', '2回戦', '3回戦', '4回戦', '5回戦', '6回戦', '最終ラウンド', 'グループステージ']], ['result', '結果 / Result', 'select', false, ['', '未設定 / Not specified', '優勝', '準優勝', '3位', '4位', '5位', '6位', '7位', '8位', 'デフォルト']]]
  };
